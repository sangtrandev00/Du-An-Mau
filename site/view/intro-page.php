...
<body>
    ...
    <div class="about-section">
        <h1>Về Cửa hàng chúng tôi</h1>
        <p>Cửa hàng DAM, chuyên cung cấp đồ điện tử chất lượng cao!</p>
        <!-- <p>Resize the browser window to see that this page is responsive by the way.</p> -->
    </div>

    <h2 class="my-4" style="text-align:center">Thành viên tại cửa hàng</h2>
    <div class="row py-3">
        <div class="column">
            <div class="card">
                <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80"
